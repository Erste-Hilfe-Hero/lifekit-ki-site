...
- [x] native Billing-Bridges kompilieren; canonical workflows PASS (Android AUTO V8 run 36035507949 410/410 API36 emulator, iOS Test V4 run 36029164149 410/410 Mobile UI 50/50 Xcode 26.6). Signed builds, devices, stores, purchases remain external gates.
