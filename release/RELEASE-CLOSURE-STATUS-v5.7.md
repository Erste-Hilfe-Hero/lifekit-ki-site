...
- Native Billing-Bridges compilation **COMPLETED**: Android API36 (`.github/workflows/nyrathen-android-auto-v8.yml`, run 36035507949 — build/install/launch on emulator) and iOS Xcode 26.6 (`.github/workflows/nyrathen-ios-test-V4.yml`, run 36029164149 — build/install/launch on simulator).
