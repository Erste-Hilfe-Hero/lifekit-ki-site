...
The app runtime and store metadata support German (`de-DE`) and English (`en-US`). In-app-purchase display names/descriptions for both languages are frozen in `store/apple-iap-metadata.v5.7.json`.
