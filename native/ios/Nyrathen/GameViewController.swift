        ...
        Task { @MainActor in
            do {
                ...
                case "purchase":
                    ...
                    guard let accountId = body["accountId"] as? String, UUID(uuidString: accountId) != nil else { throw StoreBridgeError("Ungültige Account-ID (UUID erforderlich).") }
                    
                    let appAccountToken = accountId
