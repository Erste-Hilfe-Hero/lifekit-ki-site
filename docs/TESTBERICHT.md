...
- **40 Clients**, **2 Realms**, **30 Sekunden**.
- 1 erzwungener Stream-Abbruch, 1 erfolgreicher Reconnect.
- 0 Fehler.
- Private Inventare blieben privat; Weltisolation und Identitäten blieben korrekt.
- 161 Full Frames + 5.360 Delta Frames.
- Delta-Ersparnis: **76,88 %** gegenüber Full-Snapshot-Referenz derselben Frames.
